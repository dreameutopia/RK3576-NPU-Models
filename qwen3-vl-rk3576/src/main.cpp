...
int main(int argc, char** argv)
{
    if (argc < 7) {
        std::cerr << "Usage: " << argv[0]
                ...
                << "  img_start         Image start token (default: <|vision_start|>)\n"
                << "  img_end           Image end token (default: <|vision_end|>)\n"
                << "  img_content       Image content token (default: <|image_pad|>)\n";
        return -1;
    }
    ...
    param.repeat_penalty = 1.5;
    param.frequency_penalty = 0.5;
    param.presence_penalty = 0.5;
