...
echo "   cp /path/to/qwen3-vl-2b_vision_rk3576.rknn install/demo_Linux_aarch64/models/"
echo "   cp /path/to/qwen3-vl-2b-instruct_w4a16_g128_rk3576.rkllm install/demo_Linux_aarch64/models/"
echo ""
