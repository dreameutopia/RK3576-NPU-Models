...
echo "=========================================="
echo "Setting up Qwen3-VL RK3576 deployment"
echo "=========================================="
...
echo "   cp /path/to/qwen3-vl-2b_vision_rk3576.rknn models/"
echo "   cp /path/to/qwen3-vl-2b-instruct_w4a16_g128_rk3576.rkllm models/"
echo ""
