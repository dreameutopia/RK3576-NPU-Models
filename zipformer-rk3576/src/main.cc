...
int main(int argc, char **argv)
{
    ...
    printf("==========================================\n");
    printf("Zipformer ASR Demo for RK3576\n");
    printf("==========================================\n");
    printf("Encoder: %s\n", encoder_path);
    printf("Decoder: %s\n", decoder_path);
    printf("Joiner: %s\n", joiner_path);
    ...
    if (audio.num_channels == 2)
    {
        ...
        printf("Converted to mono channel\n");
    }
    ...
    printf("Audio preprocessing time: %.2f ms\n\n", end_time - start_time);

    printf("[1/3] Loading encoder model...\n");
    start_time = get_time_ms();
    ...
    end_time = get_time_ms();
    printf("Encoder model loaded in %.2f ms\n\n", end_time - start_time);

    printf("[2/3] Loading decoder model...\n");
    start_time = get_time_ms();
    ...
    end_time = get_time_ms();
    printf("Decoder model loaded in %.2f ms\n\n", end_time - start_time);

    printf("[3/3] Loading joiner model...\n");
    start_time = get_time_ms();
    ...
    end_time = get_time_ms();
    printf("Joiner model loaded in %.2f ms\n\n", end_time - start_time);
    ...
    end_time = get_time_ms();
    infer_time = (end_time - start_time) / 1000.0;
