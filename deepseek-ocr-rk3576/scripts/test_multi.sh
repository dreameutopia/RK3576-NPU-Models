...
VISION_MODEL=$(find_model "deepseekocr_vision_rk3576.rknn")
LLM_MODEL=$(find_model "deepseekocr_w4a16_rk3576.rkllm")
...
if [ -z "$VISION_MODEL" ] || [ ! -f "$VISION_MODEL" ]; then
    ...
    echo "  ./models/deepseekocr_vision_rk3576.rknn"
    echo "  ../models/deepseekocr_vision_rk3576.rknn"
    exit 1
fi
...
if [ -z "$LLM_MODEL" ] || [ ! -f "$LLM_MODEL" ]; then
    ...
    echo "Please copy model to one of these locations:"
    echo "  ./models/deepseekocr_w4a16_rk3576.rkllm"
    echo "  ../models/deepseekocr_w4a16_rk3576.rkllm"
    exit 1
fi

echo "=========================================="
echo "DeepSeek-OCR RK3576 Multi-Image Concurrent Test"
echo "=========================================="
...
run_single_test() {
    local image_path=$1
    local task_id=$2
    local log_file="/tmp/deepseekocr_task_${task_id}.log"
